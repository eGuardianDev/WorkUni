...
using namespace std;
    ...
    // I'm working on project and not sure if I need to do this homework, but still did it
...
class Object3d {
   ...
   Object3d(string data,int a){
    ...
    void save(const string& file){
        ...
        if(!output.is_open()) throw invalid_argument("Couldn't create file with name " +file);
    ...
    void print(ostream& os){
        ...
        if(!os.good()){
            throw invalid_argument("Current stream not good");
        }
        os << data;
    }
    ...
    Object3d cut(function<bool(float x, float y, float z)> f){
        ...
        // everything else is tested and should work (except the sphere generation)
